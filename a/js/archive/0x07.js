...
function displayPetDetails() {
    ...
    // Sets petAnimal Var based on Type 
    switch (petType) {
        case "Dog":
            petAnimal = "Dog";
            break;
...
/* CONFIG */
// VARS - Stats, Max Stat, Game Over, Interval
...
/* Animal Death Checker */
// Switch(True) - Always, If stats.x is equal or lesser than 0 then (EndGame)
// End Game (Set gameOver to True, Ends Loop, Disables the Buttons)
...
// updateStatDisplays() - This is Used to Display the Stats Value
// changePetImage() - Checks if the Pet is Sad, If Not Happy Pet!
// animalDeathChecker() - Death Checker
...
/* EXTRA BUTTONS */
//    dbAndButtons() - This Disables the Actions Listed, these are used to Feed, Play, Drink, Wash
